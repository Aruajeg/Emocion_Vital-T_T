...
if(empty($nombre1) || empty($apellido1) || empty($n_documento)) {
    header("Location: ../registrarpaciente.php?mensaje=Los campos marcados con * son obligatorios");
    exit();
}

// Insertar en la base de datos
$sql = "INSERT INTO paciente (Nombre_1, Nombre_2, Apellido_1, Apellido_2, Correo, Telefono, N_documento, Tipo_documento, Fecha_nacimiento, Sexo, desc_paciente) 
        VALUES ('$nombre1', '$nombre2', '$apellido1', '$apellido2', '$correo', '$telefono', '$n_documento', '$tipo_documento', '$fecha_nacimiento', '$sexo', '$desc_paciente')";
...
if ($conn->query($sql) === TRUE) {
    ...
    header("Location: ../registrarpaciente.php?mensaje=Error al registrar paciente: " . $conn->error);
}
