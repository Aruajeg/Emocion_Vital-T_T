                ...
                <table class="table-citas">
                    ...
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/php/modificarcita.php?id=<?= $row['ID_solicitud'] ?>" title="Modificar"><i class="fas fa-edit"></i></a>
                                <a href="/php/eliminarcita.php?id=<?= $row['ID_solicitud'] ?>" title="Eliminar" onclick="return confirm('¿Seguro que deseas eliminar esta cita?');"><i class="fas fa-trash-alt" style="color:#e74c3c;"></i></a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </table>
