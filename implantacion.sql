...
CREATE TABLE `cronograma` (
  ...
  `Status` enum('Disponible','Ocupado','Realizado','disponible','ocupado','realizado','DISPONIBLE','OCUPADO','REALIZADO') NOT NULL,
  `Hora_star` time NOT NULL,
...
INSERT INTO `cronograma` (`ID_cronograma`, `ID_paciente`, `ID_psicologo`, `ID_usuario`, `Status`, `Hora_star`, `Hora_end`, `Fecha`) VALUES
(1, 0, 0, 0, 'Disponible', '08:00:00', '08:45:00', '0000-00-00');
...
CREATE TABLE `empresa` (
  ...
  `Status` enum('Activo','Inactiva') NOT NULL,
  `Correo_empr` varchar(250) NOT NULL,
  `Telefono_empr` varchar(11) NOT NULL,
...
CREATE TABLE `factura` (
  ...
  `Status` enum('Activo','Inactivo') NOT NULL,
  `Descr_factura` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Estructura de tabla para la tabla `solicitar_cita`
--
...
ALTER TABLE `consulta`
  ...
  ADD KEY `Paciente-Consul` (`ID_paciente`),
  ADD KEY `Psicologo-Consul` (`ID_psicologo`),
  ADD KEY `Solicitud-Consul` (`ID_solicitud`);
...
ALTER TABLE `cronograma`
  ...
  ADD KEY `Paciente-Cro` (`ID_paciente`),
  ADD KEY `Psicologo-Cro` (`ID_psicologo`),
  ADD KEY `Usuario-Cro` (`ID_usuario`);
...
ALTER TABLE `direccion`
  ...
  ADD KEY `Ciudad-Dir` (`ID_ciudad`),
  ADD KEY `Estado-Dir` (`ID_estado`),
  ADD KEY `Municipio-Dir` (`ID_municipio`),
  ADD KEY `Parroquia-Dir` (`ID_parroquia`),
  ADD KEY `Paciente-Dir` (`ID_paciente`);
...
ALTER TABLE `empresa`
  ...
  ADD KEY `Empresa-Dir` (`ID_direccion`);
...
ALTER TABLE `factura`
  ...
  ADD KEY `Pago-Fact` (`ID_pago`),
  ADD KEY `Empresa-Fact` (`ID_empresa`),
  ADD KEY `Solicitud-Fact` (`ID_solicitud`);
...
ALTER TABLE `paciente`
  ...
  ADD KEY `Usuario-Pacien` (`ID_usuario`),
  ADD KEY `Direccion-Pacien` (`ID_direccion`);
...
ALTER TABLE `pago`
  ...
  ADD KEY `Paciente-Pago` (`ID_paciente`),
  ADD KEY `Psicologo-Pago` (`ID_psicologo`);
...
ALTER TABLE `pariente`
  ...
  ADD KEY `Paciente-Parient` (`ID_paciente`),
  ADD KEY `Usuario-Parient` (`ID_usuario`);
...
ALTER TABLE `psicologo`
  ...
  ADD KEY `Usuario-Psico` (`ID_usuario`),
  ADD KEY `Direccion-Psico` (`ID_direccion`);

--
-- Indices de la tabla `solicitar_cita`
--
ALTER TABLE `solicitar_cita`
  ADD PRIMARY KEY (`ID_solicitud`),
  ADD KEY `Crono-Solic` (`ID_cronograma`);
...
--
ALTER TABLE `diascronograma`
  MODIFY `ID_diascronograma` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1465;
